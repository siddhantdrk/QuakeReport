...
public final class QueryUtils {
    ...
    /**
     * Query the USGS dataset and return an {@link java.util.List} object to represent a single earthquake.
     */
...
//        }
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String JSON_RESPONSE) {
        ...
        try {
            ...
            JSONObject SampleJason=new JSONObject(JSON_RESPONSE);
            JSONArray Features=SampleJason.getJSONArray("features");
            for(int i=0;i<10;i++){
